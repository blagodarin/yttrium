...
function(get_target_arch _variable)
	if(CMAKE_CXX_COMPILER_ID STREQUAL "Clang" OR CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
		execute_process(COMMAND ${CMAKE_CXX_COMPILER} -E -P ${PROJECT_SOURCE_DIR}/cmake/arch.cpp OUTPUT_VARIABLE _target_arch)
	elseif(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
		execute_process(COMMAND ${CMAKE_CXX_COMPILER} /EP /nologo ${PROJECT_SOURCE_DIR}/cmake/arch.cpp OUTPUT_VARIABLE _target_arch)
		# https://developercommunity.visualstudio.com/content/problem/325122/c1356-unable-to-find-mspdbcoredll.html
		if(NOT _target_arch AND CMAKE_SYSTEM_PROCESSOR STREQUAL "AMD64")
			set(_target_arch "amd64")
		endif()
	endif()
	string(STRIP "${_target_arch}" _target_arch)
	set(${_variable} "${_target_arch}" PARENT_SCOPE)
endfunction()

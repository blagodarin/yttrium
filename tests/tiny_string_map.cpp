...
BOOST_AUTO_TEST_CASE(tiny_string_map_find)
{
	TinyStringMap m;
...
BOOST_AUTO_TEST_CASE(tiny_string_map_insert)
{
	TinyStringMap m;
	m.insert_or_assign({}, {});
...
BOOST_AUTO_TEST_CASE(tiny_string_map_erase)
{
	TinyStringMap m;
	m.insert_or_assign({}, {});
	m.insert_or_assign("test", "value");
...
BOOST_AUTO_TEST_CASE(tiny_string_map_assign)
{
	TinyStringMap m;
	m.insert_or_assign({}, {});
	m.insert_or_assign("test", "value");
...
BOOST_AUTO_TEST_CASE(tiny_string_map_copy_construction)
{
	TinyStringMap m;
	m.insert_or_assign({}, {});
	m.insert_or_assign("test", "value");
...
BOOST_AUTO_TEST_CASE(tiny_string_map_move_construction)
{
	TinyStringMap m;
	m.insert_or_assign({}, {});
	m.insert_or_assign("test", "value");
...
BOOST_AUTO_TEST_CASE(tiny_string_map_shrinking_assignment)
{
	TinyStringMap m;
	m.insert_or_assign({}, {});
	m.insert_or_assign("test", "value");
...
BOOST_AUTO_TEST_CASE(tiny_string_map_expanding_assignment)
{
	TinyStringMap m;
...
BOOST_AUTO_TEST_CASE(tiny_string_map_self_assignment)
{
	TinyStringMap m;
	m.insert_or_assign({}, {});
	m.insert_or_assign("test", "value");
...
BOOST_AUTO_TEST_CASE(tiny_string_map_move_assignment)
{
	TinyStringMap m;
	m.insert_or_assign("a", "b");
	m.insert_or_assign("c", "d");
...
BOOST_AUTO_TEST_CASE(tiny_string_map_limit)
{
	TinyStringMap m;

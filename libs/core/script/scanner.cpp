	...
	ScriptScanner::Token ScriptScanner::read()
	{
		...
		for (;;)
		{
			...
			case C::Id:
			{
				...
				do
					++_cursor;
				while (::kind_of[static_cast<unsigned char>(*_cursor)] == C::Id || ::kind_of[static_cast<unsigned char>(*_cursor)] == C::Digit);
			...
			case C::Digit:
			{
				...
				do
					++_cursor;
				while (::kind_of[static_cast<unsigned char>(*_cursor)] == C::Digit);
				token.string = { begin, static_cast<size_t>(_cursor - begin) };
			}
			...
			case C::Space:
				do
					++_cursor;
				while (::kind_of[static_cast<unsigned char>(*_cursor)] == C::Space);
				break;
